...
var reviewServer = "http://localhost:3000/";//"http://PublicFacinhLoadBalancer-963003080.us-east-2.elb.amazonaws.com:3000";
...
app.post('/reviews/:id', function(request, response) {
	console.log("Inside review post-----------------------------");

	var jsonToSend = {
		"ReviewString": request.body.ReviewString,
		"ProductIDString":  request.body.ProductIDString
	};
